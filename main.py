...
def main(agent_config, env_config, index, monitor, after,
    ...
    save_file = save_dir + env_config["env_name"] + "_" + \
        agent_config["agent_name"] + f"_expectile_{agent_config['parameters']['use_expectile'][0]}_{agent_config['parameters']['expectile'][0]}" + f"_data_{index}_{agent_config['parameters']['save_suffix'][0]}" + ".pkl"
